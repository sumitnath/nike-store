...
const CartCount = ({onCartToggle,onClearCartItems,totalQTY}) => {
  return (
    ...
    justify-between px-3 top-0 left-0 right-0 w-full "
    >
      ...
      hover:text-orange-500 stroke-[2]"
       ...
       text-slate-100 font-normal text-xs"
            >
              ({totalQTY} <span></span>items)
            </span>
          </h1>
        </div>
      </div>
      <div className="flex items-center">
       ...
       active:scale-90 p-0.5" onClick={onClearCartItems}
        >
