...
const FlexContentt = ({ifExists,flexCont:{heading,title,text,btn,url,img}}) => {
  ...
  return (
    ...
    <button type="button" className='button-theme
     bg-slate-900 shadow-slate-900 text-slate-100 py-1.5' >{btn}</button>
    </a>
    </div>
